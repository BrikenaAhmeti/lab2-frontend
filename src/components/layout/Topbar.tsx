...
export default function Topbar({ portal }: { portal: PortalConfig }) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-border bg-card/95 px-3 py-2.5 shadow-sm backdrop-blur-xl sm:px-4 md:px-6">
      <div className="flex items-center justify-between gap-2 sm:gap-3">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <h1 className="truncate text-base font-semibold text-foreground sm:text-lg md:text-xl">{portal.title}</h1>
          </div>
        </div>
