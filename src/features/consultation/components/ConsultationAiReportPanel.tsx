...
export default function ConsultationAiReportPanel({
  ...
  const saveReport = async () => {
    ...
    try {
      ...
      setSuccess('AI report edits saved.');
    } catch (saveError) {
      ...
      <div className="space-y-4">
        ...
        <label htmlFor="ai-consultation-report" className="block space-y-1.5">
          ...
          <textarea
            ...
            value={reportText}
            disabled={!canEdit || updateSummaryMutation.isPending}
            ...
            placeholder={
              transcript
                ? 'AI report appears automatically after recording. Edit the text here if needed.'
                : 'Record and transcribe the conversation to create an AI report automatically.'
            }
          />
        </label>
